...
```sh
pip install git+https://github.com/kedros-as/gitea_client.git
```
(you may need to run `pip` with root permission: `sudo pip install git+https://github.com/kedros-as/gitea_client.git`)
